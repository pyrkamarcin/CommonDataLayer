...
namespace CDL.Tests.ServicesTests.MaterializerGeneral
{
    public class ElasticsearchTests
    {
        ...
        public void SingleSchema_WithRelations()
        {
            ...
            var result = RetryHelper.TryFetch(() => ElasticsearchConnector.QueryAll<PersonView2>(new Uri(_options.CDL_ELASTICSEARCH_NODE), indexName), arr => arr.Count == 0).Result.ToArray();
